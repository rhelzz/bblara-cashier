...
class NotificationInventarisController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $view = view('inventaris.notification.partials.notifications', compact('notifications'))->render();
        ...
        return view('inventaris.notification.index', compact('notifications'));
    }
