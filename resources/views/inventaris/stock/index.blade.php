                ...
                <div class="p-6 bg-gray-100 min-h-screen">
                    <div class="max-w-7xl mx-auto">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <a href="{{ route('inventaris.stock.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">
                                Tambah Stok
                            </a>
                        </div>
                        @if(session('success'))
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex space-x-2">
                                                        <a href="{{ route('inventaris.stock.show', $stock) }}" class="inline-flex items-center px-3 py-1.5 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                                            <i class="bi bi-eye mr-1"></i>
                                                            Lihat
                                                        </a>
                                                        <a href="{{ route('inventaris.stock.edit', $stock) }}" class="inline-flex items-center px-3 py-1.5 bg-yellow-500 text-white text-sm font-medium rounded-md hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex space-x-2">
                                                        <form action="{{ route('inventaris.stock.increment', $stock->id) }}" method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                        ...
                                                        <form action="{{ route('inventaris.stock.decrement', $stock->id) }}" method="POST">
                                                            @csrf
                                                            @method('PATCH')
